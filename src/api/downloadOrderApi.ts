...
export const downloadOrderFiles = (items: DownloadOrderDownloadItem[], userAgent?: string, proxy?: string) =>
  invokeTauri<DownloadOrderDownloadResult[]>('download_order_download_files_cmd', { items, userAgent, proxy });
